...
/*   Updated: 2023/12/20 16:24:07 by seojulee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScavTrap::attack(const std::string& target) {
	if (!checkHealth() || !checkEnergy())
		return ;
	this->Energy_points--;
	std::cout << RGB_GREEN << "ScavTrap " << this->Name << " attacks " << target << ", causing "
	<< this->Attack_damage << " points of damage!" << RGB_NONE << std::endl;
}
